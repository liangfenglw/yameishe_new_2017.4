...
if($(this).attr("formnovalidate")==="formnovalidate"){validator.cancelSubmit=true;}});this.on("submit.validate",function(event){if(validator.settings.debug){event.preventDefault();}
