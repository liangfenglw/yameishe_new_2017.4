...
(function(window,undefined){
	...
	TouchScroll.fn=TouchScroll.prototype={
		...
		refresh:function(flag){
			var bar=this[flag+'bar'], //滚动�?
				total=this['total'+sg[flag][0]], //视图总长�?
				client=this[sg[flag][0].toLowerCase()], //视图可见长度
				origPos=this[flag+'Offset'], //当前的位�?
				deftPos=-this.cfg[flag+'Offset'], //初始默认容差
				minLength=Math.max(this.cfg.width,this.cfg.minLength), //滚动条最小长�?
				length=Math.max(parseFloat(client*client/total),minLength), //滚动条正常长�?
